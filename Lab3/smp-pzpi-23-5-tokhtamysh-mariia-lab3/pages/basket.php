...
<nav class="navbar">
    ...
    <a href="../pages/product.php" class="nav-item">
...
<main class="cart-page eco-container">
    ...
    <?php if (isset($_SESSION['checkout_success']) && $_SESSION['checkout_success']): ?>
        <div class="eco-success-box">
            ...
            <a href="product.php" class="eco-btn">Start New Shopping</a>
        </div>
    ...
    <?php elseif (!empty($cartItemsList)): ?>
        ...
        <div class="cart-page__actions eco-action-buttons">
          <a href="product.php" class="eco-btn">Cancel</a>
          <form method="post" action="">
...
<footer class="footer">
    <div class="footer__nav">
        ...
        <a href="../pages/product.php" class="footer__link">Products</a> |
